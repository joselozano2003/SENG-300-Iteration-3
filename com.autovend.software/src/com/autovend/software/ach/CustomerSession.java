...
public class CustomerSession {
	...
	public CustomerSession(SelfCheckoutStation station, BarcodedProduct reusableBagProduct, VirtualBagDispenser bagDispenser) {
		if (station == null)
    		throw new NullPointerException("Station cannot be null");
		if (reusableBagProduct == null)
    		throw new NullPointerException("Product cannot be null");
		if (bagDispenser == null)
    		throw new NullPointerException("Dispenser cannot be null");
