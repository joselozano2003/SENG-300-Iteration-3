...
public class AttendantControllerTest {
    ...
    public void testAddCustomerStation() {
        ...
        assertEquals(1, attendantController.getCustomerStations().size());
    }
    ...
    public void testDenyStationUse(){
        ...
        state = station.getController().getState();
        assertEquals(CustomerController.State.DISABLED, state);
    }
    ...
    public void testRemoveItem() {
        ...
        assertEquals(3, customerController.getSession().getTotalCost().intValue());
